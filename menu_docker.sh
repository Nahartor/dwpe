...
# A continuación podrá encontrar el código en español. Si desea usar este script en español solo tiene que borrar todo entre la primera línea del texto y la linea 59 (y los caracteres # delante de cada linea restante). 
